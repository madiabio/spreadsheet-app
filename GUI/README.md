...
``
This project represents the main web server program which holds the default pages for the spreadsheet GUI program.
``

#### Contents of this Project
- This project interacts with GUI.Client project to represent a fully functioning spreadsheet view.
