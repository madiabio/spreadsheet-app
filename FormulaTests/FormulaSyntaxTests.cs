...
public class FormulaSyntaxTests
{
    ...
    [TestMethod]
    [ExpectedException(typeof(FormulaFormatException))]
    public void FormulaConstructor_TestValidTokenELower_Invalid()
    {
        _ = new Formula("e");
    }
    ...
    [TestMethod]
    [ExpectedException(typeof(FormulaFormatException))]
    public void FormulaConstructor_TestValidTokenEUpper_Invalid()
    {
        _ = new Formula("E");
    }
    ...
    [TestMethod]
    [ExpectedException(typeof(FormulaFormatException))]
    public void FormulaConstructor_TestValidTokenVariableLower_Invalid()
    {
        _ = new Formula("a");
    }
    ...
    /// <para>
    ///     This test checks to see if the correct exception will be thrown
    ///     for an uppercase character that wouldn't be related to issues with
    ///     scientific notation (ie, it checks the character 'A").
    /// </para>
    /// </summary>
    [TestMethod]
